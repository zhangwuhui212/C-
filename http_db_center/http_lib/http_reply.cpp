...
namespace http
{
	namespace status_strings {
		...
		std::string to_buffer(http_reply::status_type status)
		{
			switch (status)
			{
			case http_reply::ok:
	...
	std::string http_reply::to_buffers()
	{
		std::string str;
		str = status_strings::to_buffer(http_status);
...
// 		str += misc_strings::crlf;
	...
	namespace stock_replies {
		...
		std::string to_string(http_reply::status_type status)
		{
			switch (status)
			{
			case http_reply::ok:
	...
	http_reply http_reply::stock_reply(http_reply::status_type status)
	{
		http_reply rep;
